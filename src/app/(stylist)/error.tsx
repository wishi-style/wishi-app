...
export default function StylistError({
  error,
  reset,
}: {
  ...
  return (
    <main className="flex min-h-[60vh] flex-col items-center justify-center gap-4 px-6 text-center">
      <h1 className="font-display text-3xl">Dashboard error</h1>
      <p className="max-w-md text-muted-foreground">
        We couldn&apos;t load this view. Your client sessions and drafts are
        untouched.
      </p>
      {error.digest ? (
